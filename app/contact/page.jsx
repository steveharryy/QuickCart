        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <div>
            ...
            <p className="text-gray-600 mb-8">
              Whether you have a question about products, pricing, shipping, or anything else, our team is ready to answer all your questions.
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">contact@greatstack.dev</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent outline-none resize-none transition"
            ...
            <div className="grid md:grid-cols-2 gap-6 text-left">
              <div className="bg-white p-6 rounded-lg">
                ...
                <p className="text-gray-600 text-sm">
                  We offer standard and express shipping. Most orders are delivered within 3-7 business days.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg">
                ...
                <p className="text-gray-600 text-sm">
                  Yes, we ship to select countries worldwide. Shipping costs vary by destination.
                </p>
              </div>
